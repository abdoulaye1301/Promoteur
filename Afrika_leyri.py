...
if menu == "AGREGATION":
    ...
    if sous_menu == "Versement":
        ...
        colone= st.columns(3)
        colone[0].metric("💴 CA TATA 1", f"{donnee_ordre[donnee_ordre["team_leader"] =="DJIBRIL DIOP"]["Montant A verser"].sum():,.2f}".replace(",", " ")+" XOF")
        colone[1].metric("💴 CA TATA 2", f"{donnee_ordre[donnee_ordre["team_leader"] =="ALIOUNE BADARA (MANSOUR) SANE"]["Montant A verser"].sum():,.2f}".replace(",", " ")+" XOF")
        colone[2].metric("💴 CA TATA 3", f"{donnee_ordre[donnee_ordre["team_leader"] =="IBRAHIMA COLY"]["Montant A verser"].sum():,.2f}".replace(",", " ")+" XOF")
        colone[0].write(" ")
        #colone[2].write(" ")
        colone[1].write(" ")
        colonne= st.columns(3)
        colonne[0].metric("🚐 Transport TATA 1", f"{statio[statio["team_leader"] =="DJIBRIL DIOP"]["Transport"].sum():,.0f}".replace(",", " ")+" XOF")
        colonne[1].metric("🚐 Transport TATA 2", f"{statio[statio["team_leader"] =="ALIOUNE BADARA (MANSOUR) SANE"]["Transport"].sum():,.0f}".replace(",", " ")+" XOF")
        colonne[2].metric("🚐 Transport TATA 3", f"{statio[statio["team_leader"] =="IBRAHIMA COLY"]["Transport"].sum():,.0f}".replace(",", " ")+" XOF")
        colonne[0].write(" ")
        #colonne[2].write(" ")
        colonne[1].write(" ")
        colonne[0].metric("🅿️ Stationnement TATA 1", f"{statio[statio["team_leader"] =="DJIBRIL DIOP"]["Stationnement"].sum():,.0f}".replace(",", " ")+" XOF")
        colonne[1].metric("🅿️ Stationnement TATA 2", f"{statio[statio["team_leader"] =="ALIOUNE BADARA (MANSOUR) SANE"]["Stationnement"].sum():,.0f}".replace(",", " ")+" XOF")
        colonne[2].metric("🅿️ Stationnement TATA 3", f"{statio[statio["team_leader"] =="IBRAHIMA COLY"]["Stationnement"].sum():,.0f}".replace(",", " ")+" XOF")
